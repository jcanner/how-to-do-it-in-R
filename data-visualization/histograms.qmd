...
#| echo: false
check_question(answer = c("center", "symmetry/skew", "spread", "modality", "outliers"), 
               options = c("center", "symmetry/skew", "spread", "modality", "outliers"),
               right = "Great Job! Histograms allow us to observe all of these features of a distribution",
               wrong = "Are you missing a feature of a distribution we can evaluate?",
               type = "checkbox", 
               button_label = "Check Your Answer")


check_hint(hint_text = "Take a look at a histogram, is there any feature you could not say something about?",
